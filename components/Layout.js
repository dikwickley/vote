    ...
    <div className="relative">
      ...
      <div className="absolute  flex flex-row justify-center items-center  bg-white right-1/2 top-[250px] translate-x-[50%]">
        <div
          ...
          className="flex justify-center items-center text-2xl p-2 font-mono leading-[1.5rem] text-center  h-[90px] w-[200px] m-1 cursor-pointer  transition-all duration-500 bg-gradient-to-t to-red-400   via-pink-400 from-blue-500 bg-size-200 bg-pos-0 hover:bg-pos-100"
        >
          Artist Of The Year
        </div>
        <div
